...
create index if not exists idx_boardgame_play_events_mode on boardgame_play_events(mode);
create index if not exists idx_boardgame_play_events_created_at on boardgame_play_events(created_at);
